...
export declare class ProductController {
    ...
    get(id: string): Promise<import("mongoose").Document<unknown, any, ProductModel> & ProductModel & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    delete(id: string): Promise<void>;
    patch(id: string, dto: ProductModel): Promise<import("mongoose").Document<unknown, any, ProductModel> & ProductModel & {
        _id: import("mongoose").Types.ObjectId;
    }>;
